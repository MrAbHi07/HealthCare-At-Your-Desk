...
This is a front-end medical website project aiming to help hospitals manage patient-disease-doctor relationships, and assist patients in classifying their diseases and finding relevant doctors. it would benefit from backend integration, dynamic data, real user flows (login, booking), and possibly more advanced diagnostics.
According to the README, Doctello is a medical‐website designed to:
